...
bool ga_font_material::init()
{
	...
	const char* source_fs =
		...
		"out vec4 finalColor;\n"
		"void main(void) {\n"
		"	finalColor = vec4(u_color, texture(u_texture, texcoord0).x);\n"
		"}\n";
...
void ga_font_material::bind(const ga_mat4f& view_proj, const ga_mat4f& transform, ga_frame_params* params)
{
